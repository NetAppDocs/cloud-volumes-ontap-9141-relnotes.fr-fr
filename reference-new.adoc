...
== 9.14.1 P14 (16 octobre 2025)

Le patch 9.14.1 P14 est désormais disponible pour Cloud Volumes ONTAP pour tous les fournisseurs de cloud. La console vous invitera à mettre à niveau vos systèmes existants vers cette version de correctif.

https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.14.1P14["Voir la liste des bugs corrigés dans le patch P14"^](Connexion au site de support NetApp requise).



== 9.14.1 P13 (04 juillet 2025)

Le correctif 9.14.1 P13 est désormais disponible pour Cloud Volumes ONTAP pour tous les fournisseurs cloud. BlueXP vous invitera à mettre à niveau vos systèmes existants vers cette version de correctif.

https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.14.1P13["Afficher la liste des bogues corrigés dans le correctif P13"^] (Identifiant du site du support NetApp requis).



== 9.14.1 P12 (17 avril 2025)

Le correctif 9.14.1 P12 est désormais disponible pour Cloud Volumes ONTAP pour tous les fournisseurs cloud. BlueXP vous invitera à mettre à niveau vos systèmes existants vers cette version de correctif.

https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.14.1P12["Afficher la liste des bogues corrigés dans le correctif P12"^] (Identifiant du site du support NetApp requis).



== 9.14.1 P11 (10 mars 2025)

Le correctif 9.14.1 P11 est désormais disponible pour Cloud Volumes ONTAP pour tous les fournisseurs cloud. BlueXP vous invitera à mettre à niveau vos systèmes existants vers cette version de correctif.

https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.14.1P11["Afficher la liste des bogues corrigés dans le correctif P11"^] (Identifiant du site du support NetApp requis).



== 9.14.1 P10 (20 janvier 2025)

Le correctif 9.14.1 P10 est désormais disponible pour Cloud Volumes ONTAP pour tous les fournisseurs cloud. BlueXP vous invitera à mettre à niveau vos systèmes existants vers cette version de correctif.

https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.14.1P10["Afficher la liste des bogues corrigés dans le correctif P10"^] (Identifiant du site du support NetApp requis).



== 9.14.1 P9 (25 novembre 2024)

Le correctif 9.14.1 P9 est désormais disponible pour Cloud Volumes ONTAP pour tous les fournisseurs cloud. BlueXP vous invitera à mettre à niveau vos systèmes existants vers cette version de correctif.

https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.14.1P9["Afficher la liste des bogues corrigés dans le correctif P9"^] (Identifiant du site du support NetApp requis).
